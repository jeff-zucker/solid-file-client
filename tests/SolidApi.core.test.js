...
describe('core methods', () => {
  ...
  describe('creators', () => {
    ...
    test('put resolves with 201 creating a new file', () => resolvesWithStatus(api.put(newFilePlaceholder.url,{headers:{"Content-Type":"text/turtle"}}),201))
    test('put resolves with 201 overwriting a file', () => resolvesWithStatus(api.put(usedFile.url,{headers:{"Content-Type":"text/turtle"}}), 201))
    test('put resolves with 201 creating a nested files', () => resolvesWithStatus(api.put(nestedFilePlaceholder.url,{headers:{"Content-Type":"text/turtle"}}),201))
  })
