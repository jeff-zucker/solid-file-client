"use strict";
/*import Rest from './solid-rest/src/rest.js' // './solid-rest/src/rest.js'
import File from './solid-rest/src/file.js'
import Mem from './solid-rest/src/localStorage'
*/
let Rest = require('./solid-rest/src/rest.js') // 'solid-rest/src/rest.js');
var rest 
function setRestHandlers(handlers){
  if(typeof handlers !="undefined"){
    ...
    let File = require('./solid-rest/src/file.js') // 'solid-rest/src/file.js');
    let Mem = require('solid-rest/src/localStorage.js') // 'solid-rest/src/localStorage.js');
